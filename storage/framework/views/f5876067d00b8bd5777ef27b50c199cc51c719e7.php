  ...
  <div class="container-fluid">
      ...
      <div style="margin-bottom:15px;">
        ...
        <div class="col-xs-4">
          ...
          <h4 class="factura-label">
              <?php echo e($client->social_reason); ?>
      ...
      <div class="row">
          ...
          <div class="col-xs-1">
            ...
            <h4 class="factura-label">
                <?php echo e($client->external_number); ?>
          ...
          <div class="col-xs-1">
            ...
            <h4 class="factura-label">
                <?php echo e($client->internal_number); ?>
          ...
          <div class="col-xs-2">
              ...
              <h4 class="factura-label">
                <?php echo e($data_order->created_at); ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
              ...
              <h4 class="factura-label">
                <?php echo e($data_order->order_number); ?>
      ...
      <div class="portlet-body">
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <?php $__currentLoopData = $data_sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td>
                    <?php echo e($sale->product->barCode); ?>
    ...
    <div>
      <div style="text-align:right;">
        <h5><strong>Subtotal:</strong></h5><h5 style="font-weight:100; color: rgb(121, 121, 121);"><span>$ </span><?php echo e($data_order->subtotal); ?></h5>
      </div>

      <div style="text-align:right;">
        <h5><strong>IVA:</strong></h5><h5 style="font-weight:100; color: rgb(121, 121, 121);"><span>$ </span><?php echo e($data_order->iva); ?></h5>
      </div>

      <div style="text-align:right;">
        <h5><strong>Total:</strong></h5><h5 style="font-weight:100; color: rgb(121, 121, 121);"><span>$ </span><?php echo e($data_order->totales); ?></h5>
      </div>
    </div>
